...
parser.add_argument('--rank-size', default=0, type=int,
                    help='number of distributed processes')
parser.add_argument('--device_id', default=0, type=int, help='device id')
parser.add_argument('--world-size', default=1, type=int,
                    help='number of distributed processes')
parser.add_argument('--dist-url', default='env://10.199.109.168',
...
if args.distributed:
    if 'RANK_SIZE' in os.environ and 'RANK_ID' in os.environ:
        ...
        args.world_size = args.rank_size
        args.device_id = args.rank_id
        args.bs = int(args.bs / args.rank_size)
...
print("Use NPU: rank_id={} for training".format(args.rank_id))
print("Use NPU: device_id={} for training".format(args.device_id))
...
if args.distributed:
    train_sample = torch.utils.data.distributed.DistributedSampler(trainloader)
    test_sample = torch.utils.data.distributed.DistributedSampler(testloader)
else:
    train_sample = None
    test_sample = None 
